...
export default function Perfil({ navigation }) {
  ...
  const salvarDados = async () => {
    try {
      ...
      await AsyncStorage.setItem('selectedDateFormatted', selectedDateFormatted || '');
  ...
  useEffect(() => {
    salvarDados();
  }, [nomeCer, telefoneCer, barbeiroSelecionado, servicosSelecionados, selectedDateFormatted, selectedTime]);
